...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className='mx-auto grid h-auto w-full grid-cols-1 gap-3 bg-grayShade p-3 sm:container dark:bg-inherit sm:p-4 md:grid-cols-1 md:gap-5 md:py-3 lg:grid-cols-5 xl:grid-cols-6'>
        {/* -----Left-Column----- */}
        <div className='flex h-full w-full flex-col gap-y-3 rounded-xl md:gap-y-5 lg:col-span-3 xl:col-span-4'>
          ...
          {forecast === null ? (
            ...
            <section className='h-auto w-full rounded-2xl py-4 md:p-6 lg:py-2'>
              {/* -----Tabs-Button----- */}
